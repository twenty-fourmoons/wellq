...
public class StoreBookDialog extends JDialog{
	...
	public StoreBookDialog (String year, String matterID) {
		setTitle("≤÷ø‚’À±æ");
		pyear = year;
		pmatterID = matterID;
		try {
	...
	private void jbInit() throws JRException, ClassNotFoundException, SQLException {
		...
		String reportPath = "G:\\java-eclipse(mars2)\\workspa\\ManageSystem\\Reports\\storeReport.jasper";
		JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile(reportPath);
		
		Map parameters = new HashMap();
		parameters.put("year", pyear);
		parameters.put("matterID", pmatterID);
